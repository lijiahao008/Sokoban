...
function showInstruction() {
	...
	`<h4>Instructions: </br></br>To Start the game: Click on Listen or
	 Continuous Listen, give your browser access to your microphone and
...
function closeInstruction() {
	...
	document.getElementById("instructions").replaceWith(instructions_holder);
}
