...
function showInstruction() {
	...
	"<h4>Instructions: </br></br>To Start the game: Click on Listen or Continuous Listen and say your command (ex: start the game, next level, go up, move left...) or click on start and use your keyboard.</br></br>The goal of the game is to push all the boxes into the targets. You can not push two boxes together.</br></br><button onclick='start()'>Start the Game</button></h4>"
